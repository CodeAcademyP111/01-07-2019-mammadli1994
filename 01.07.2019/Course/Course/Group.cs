    ...
    public class Group
    {
        ...
        public void AddStudent(Student student,int price)
        {
            ...
            if(exist_stdn_count< countStudent && price>=Price)
            {
                ...
                Console.WriteLine("Thank you,Welcome Code Academy!!!");
            }
            else
            {
                Console.WriteLine($"Group is full or money not enough {student.Name}");
            }
        }
        public void ListGroup()
        {
            ...
            {
                Console.WriteLine($" Adiniz:{item.Name},Ixtisasiniz: {Type.Typename},Grupunuzun adi: {GroupName}");
            }
        }
